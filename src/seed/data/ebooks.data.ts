...
const preEbooks = [
    ...
    {
        title: "El señor de los anillos, el retorno de rey",
        category: "Fantasía",
        author: authorsMap["J.R.R. Tolkien"],
        publisher: "Minotauro",
...
const ebooks: Ebook[] = preEbooks.map((ebook) => {return {id: uuid(), ...ebook, ebookCover: ("_" + ebook.ebookCover)}});
